...
export class RegionMatches extends AbstractFunction {
    ...
    public static PARAMETER_STRING: Parameter = new Parameter()
        .setParameterName(RegionMatches.PARAMETER_STRING_NAME)
        .setSchema(Schema.ofString(RegionMatches.PARAMETER_STRING_NAME));

    protected static PARAMETER_OTHER_STRING: Parameter = new Parameter()
        .setParameterName(RegionMatches.PARAMETER_OTHER_STRING_NAME)
        .setSchema(Schema.ofString(RegionMatches.PARAMETER_OTHER_STRING_NAME));

    protected static PARAMETER_FIRST_OFFSET: Parameter = new Parameter()
        .setParameterName(RegionMatches.PARAMETER_FIRST_OFFSET_NAME)
        .setSchema(Schema.ofInteger(RegionMatches.PARAMETER_FIRST_OFFSET_NAME));

    protected static PARAMETER_SECOND_OFFSET: Parameter = new Parameter()
        .setParameterName(RegionMatches.PARAMETER_SECOND_OFFSET_NAME)
        .setSchema(Schema.ofInteger(RegionMatches.PARAMETER_SECOND_OFFSET_NAME));

    protected static PARAMETER_INTEGER: Parameter = new Parameter()
        .setParameterName(RegionMatches.PARAMETER_INTEGER_NAME)
        .setSchema(Schema.ofInteger(RegionMatches.PARAMETER_INTEGER_NAME));

    protected static PARAMETER_BOOLEAN: Parameter = new Parameter()
        .setParameterName(RegionMatches.PARAMETER_BOOLEAN_NAME)
        .setSchema(Schema.ofBoolean(RegionMatches.PARAMETER_BOOLEAN_NAME));
