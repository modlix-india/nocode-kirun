...
const SIGNATURE = new FunctionSignature('GetSeconds')
...
export class GetSeconds extends AbstractFunction {
    ...
    protected async internalExecute(context: FunctionExecutionParameters): Promise<FunctionOutput> {
        ...
        return new FunctionOutput([
            EventResult.outputOf(new Map([[OUTPUT, parseInt(match[6], 10)]])),
        ]);
    }
}
