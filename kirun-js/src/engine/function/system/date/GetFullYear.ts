...
const SIGNATURE = new FunctionSignature('GetFullYear')
...
export class GetFullYear extends AbstractFunction {
    ...
    protected async internalExecute(context: FunctionExecutionParameters): Promise<FunctionOutput> {
        ...
        return new FunctionOutput([
            EventResult.outputOf(new Map([[OUTPUT, parseInt(match[1], 10)]])),
        ]);
    }
}
