...
test('Concatenate test 5', async () => {
    ...
    await expect(add.execute(fep)).rejects.toThrow("Error while executing the function System.Array.Concatenate's parameter secondSource [Expected: Array<Integer | Long | Float | Double | String | Boolean | Array | Null | Object>]: Expected an array but found null");
