...
public class ExtractDateFromDateandTime extends AbstractReactiveFunction {
	...
	private final FunctionSignature signature = new FunctionSignature().setName("ExtractDateFromDateandTime")
	...
	protected Mono<FunctionOutput> internalExecute(ReactiveFunctionExecutionParameters context) {
		...
		String date = extractDateFromDatetime(datetimeinput);
