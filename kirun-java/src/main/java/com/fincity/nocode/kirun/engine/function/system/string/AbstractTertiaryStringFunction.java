...
public abstract class AbstractTertiaryStringFunction extends AbstractReactiveFunction {
	...
	protected static final Parameter PARAMETER_SECOND_STRING = new Parameter()
			.setParameterName(PARAMETER_SECOND_STRING_NAME)
			.setSchema(Schema.ofString(PARAMETER_SECOND_STRING_NAME));

	protected static final Parameter PARAMETER_SEARCH_STRING = new Parameter()
			.setParameterName(PARAMETER_SEARCH_STRING_NAME)
			.setSchema(Schema.ofString(PARAMETER_SEARCH_STRING_NAME));

	protected static final Parameter PARAMETER_THIRD_STRING = new Parameter()
			.setParameterName(PARAMETER_THIRD_STRING_NAME)
			.setSchema(Schema.ofString(PARAMETER_THIRD_STRING_NAME));
	...
	protected static final Parameter PARAMETER_SECOND_INDEX = new Parameter()
			.setParameterName(PARAMETER_SECOND_INDEX_NAME)
			.setSchema(Schema.ofInteger(PARAMETER_SECOND_INDEX_NAME));
	...
	public static Map.Entry<String, ReactiveFunction> ofEntryStringStringStringAndStringOutput(final String name,
		...
		return Map.entry(name, new AbstractTertiaryStringFunction(Namespaces.STRING, name, PARAMETER_STRING,
			...
			protected Mono<FunctionOutput> internalExecute(ReactiveFunctionExecutionParameters context) {
				JsonPrimitive s1 = context.getArguments()
						...
						.getAsJsonPrimitive();
				JsonPrimitive oldString = context.getArguments()
						.get(PARAMETER_SECOND_STRING_NAME)
						.getAsJsonPrimitive();
				JsonPrimitive newString = context.getArguments()
						.get(AbstractTertiaryStringFunction.PARAMETER_THIRD_STRING_NAME)
						.getAsJsonPrimitive();

				return Mono.just(new FunctionOutput(
						List.of(EventResult.outputOf(Map.of(EVENT_RESULT_NAME, new JsonPrimitive(function
								.apply(s1.getAsString(), oldString.getAsString(), newString.getAsString())))))));
			}

		});
	}

	public static Map.Entry<String, ReactiveFunction> ofEntryStringIntegerIntegerAndStringOutput(final String name,
		...
		return Map.entry(name, new AbstractTertiaryStringFunction(Namespaces.STRING, name, PARAMETER_STRING,
			...
			@Override
			protected Mono<FunctionOutput> internalExecute(ReactiveFunctionExecutionParameters context) {
				JsonPrimitive string = context.getArguments()
						.get(PARAMETER_STRING_NAME)
						.getAsJsonPrimitive();
				JsonPrimitive start = context.getArguments()
						.get(PARAMETER_INDEX_NAME)
						.getAsJsonPrimitive();
				JsonPrimitive length = context.getArguments()
						.get(PARAMETER_SECOND_INDEX_NAME)
						.getAsJsonPrimitive();
				return Mono.just(
	...
	public static Map.Entry<String, ReactiveFunction> ofEntryStringStringIntegerAndIntegerOutput(final String name,
			TriFunction<String, String, Integer, Integer> function) {
		return Map.entry(name, new AbstractTertiaryStringFunction(Namespaces.STRING, name, PARAMETER_STRING,
				PARAMETER_SEARCH_STRING, PARAMETER_INDEX, EVENT_INT) {
			...
			protected Mono<FunctionOutput> internalExecute(ReactiveFunctionExecutionParameters context) {
				...
				JsonPrimitive s2 = context.getArguments()
						.get(PARAMETER_SEARCH_STRING_NAME)
						.getAsJsonPrimitive();
				JsonPrimitive index = context.getArguments()
						.get(PARAMETER_INDEX_NAME)
						.getAsJsonPrimitive();
