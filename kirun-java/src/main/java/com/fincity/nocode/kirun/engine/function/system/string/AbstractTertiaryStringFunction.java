...
public abstract class AbstractTertiaryStringFunction extends AbstractReactiveFunction {
	...
	public static Map.Entry<String, ReactiveFunction> ofEntryAsStringStringStringStringOutput(final String name,
	...
	public static Map.Entry<String, ReactiveFunction> ofEntryAsStringIntegerIntegerStringOutput(final String name,
	...
	public static Map.Entry<String, ReactiveFunction> ofEntryAsStringStringIntegerIntegerOutput(final String name,
