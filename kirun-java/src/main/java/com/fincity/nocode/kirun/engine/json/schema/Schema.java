...
public class Schema implements Serializable {
	...
	public static final Schema SCHEMA = new Schema().setNamespace(Namespaces.SYSTEM)
	        ...
	        .setName("Schema")
	        .setProperties(
	                Map.ofEntries(entry(NAMESPACE_STRING, Schema.of(NAMESPACE_STRING, STRING)),
	                        entry("name", Schema.of("name", STRING)), entry(VERSION_STRING,
	                                Schema.of(VERSION_STRING, INTEGER)
	                        ...
	                        entry("examples",
	                                Schema.ofArray("examples",
	                                        Schema.of("example", INTEGER, LONG, FLOAT, DOUBLE, STRING, OBJECT, ARRAY,
	                                                BOOLEAN, NULL))),
	                        entry("defaultValue",
	                                Schema.of("defaultValue", INTEGER, LONG, FLOAT, DOUBLE, STRING, OBJECT, ARRAY,
	                                        BOOLEAN, NULL)),
	                        entry("comment", Schema.of("comment", STRING)),
	                        entry("enums", Schema.ofArray("enums", Schema.of("enum", STRING))),
	                        entry("constant", Schema.of("constant", INTEGER, LONG, FLOAT, DOUBLE, STRING, OBJECT, ARRAY,
	                                BOOLEAN, NULL)),
