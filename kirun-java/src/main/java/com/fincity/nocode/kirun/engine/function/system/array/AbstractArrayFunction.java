...
public abstract class AbstractArrayFunction extends AbstractFunction {
	...
	protected static final Event EVENT_RESULT_ARRAY = new Event().setName(Event.OUTPUT)
	        .setParameters(
	                Map.of(EVENT_RESULT_NAME, Schema.ofArray(EVENT_RESULT_NAME, Schema.ofAny(EVENT_RESULT_NAME))));

	protected static final Event EVENT_RESULT_EMPTY = new Event().setName(Event.OUTPUT)
	        .setParameters(Map.of());

	protected static final Parameter PARAMETER_INT_LENGTH = Parameter.of("length", Schema.ofInteger("length")
	...
	protected static final Parameter PARAMETER_INT_SOURCE_FROM = Parameter.of("srcFrom", Schema.ofInteger("srcFrom")
	        .setDefaultValue(new JsonPrimitive(0)));
	protected static final Parameter PARAMETER_INT_FIND_FROM = Parameter.of("findFrom", Schema.ofInteger("findFrom")
	        .setDefaultValue(new JsonPrimitive(0)));
	...
	protected static final Parameter PARAMETER_BOOLEAN_DEEP_COPY = Parameter.of("deepCopy", Schema.ofBoolean("deepCopy")
	...
	protected AbstractArrayFunction(String functionName, List<Parameter> parameters, Event event) {
		...
		this.signature = new FunctionSignature().setNamespace(SYSTEM_ARRAY)
