...
public abstract class AbstractBinaryStringFunction extends AbstractReactiveFunction {
	...
	public static Map.Entry<String, ReactiveFunction> ofEntryStringStringAndBooleanOutput(final String name,
		...
		return Map.entry(name, new AbstractBinaryStringFunction(Namespaces.STRING, name, PARAMETER_STRING,
			...
			protected Mono<FunctionOutput> internalExecute(ReactiveFunctionExecutionParameters context) {
				...
				JsonPrimitive s = context.getArguments()
						.get(PARAMETER_STRING_NAME)
						.getAsJsonPrimitive();
				JsonPrimitive ss = context.getArguments()
	...
	public static Map.Entry<String, ReactiveFunction> ofEntryStringIntegerAndStringOutput(final String name,
		...
		return Map.entry(name, new AbstractBinaryStringFunction(Namespaces.STRING, name, PARAMETER_STRING,
			...
			protected Mono<FunctionOutput> internalExecute(ReactiveFunctionExecutionParameters context) {
				JsonPrimitive s = context.getArguments()
						.get(PARAMETER_STRING_NAME)
						.getAsJsonPrimitive();
				JsonPrimitive count = context.getArguments()
	...
	public static Map.Entry<String, ReactiveFunction> ofEntryStringStringAndIntegerOutput(final String name,
	...
	public static Map.Entry<String, ReactiveFunction> ofEntryAsStringArrayOutput(final String name,
