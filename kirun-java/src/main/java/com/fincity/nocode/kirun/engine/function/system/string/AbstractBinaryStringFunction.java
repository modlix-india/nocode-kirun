...
public abstract class AbstractBinaryStringFunction extends AbstractReactiveFunction {
	...
	public static Map.Entry<String, ReactiveFunction> ofEntryAsStringBooleanOutput(final String name,
	...
	public static Map.Entry<String, ReactiveFunction> ofEntryAsStringAndIntegerStringOutput(final String name,
	...
	public static Map.Entry<String, ReactiveFunction> ofEntryAsStringIntegerOutput(final String name,
