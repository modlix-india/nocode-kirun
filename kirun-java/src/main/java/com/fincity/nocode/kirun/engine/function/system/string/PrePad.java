...
public class PrePad extends AbstractReactiveFunction {
	...
	protected static final Parameter PARAMETER_PREPAD_STRING = new Parameter()
	        .setParameterName(PARAMETER_PREPAD_STRING_NAME)
	        .setSchema(Schema.ofString(PARAMETER_PREPAD_STRING_NAME));
	...
	protected Mono<FunctionOutput> internalExecute(ReactiveFunctionExecutionParameters context) {
		String inputString = context.getArguments()
		        ...
		        .getAsJsonPrimitive()
		        .getAsString();
		String prepadString = context.getArguments()
		        .get(PARAMETER_PREPAD_STRING_NAME)
		        .getAsJsonPrimitive()
		        .getAsString();
