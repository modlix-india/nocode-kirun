...
public class PostPad extends AbstractReactiveFunction {
	...
	protected static final Parameter PARAMETER_POSTPAD_STRING = new Parameter()
	        .setParameterName(PARAMETER_POSTPAD_STRING_NAME)
	        .setSchema(Schema.ofString(PARAMETER_POSTPAD_STRING_NAME));
	...
	protected Mono<FunctionOutput> internalExecute(ReactiveFunctionExecutionParameters context) {
		String inputString = context.getArguments()
		        ...
		        .getAsJsonPrimitive()
		        .getAsString();
		String postpadString = context.getArguments()
		        .get(PARAMETER_POSTPAD_STRING_NAME)
		        .getAsJsonPrimitive()
		        .getAsString();
		Integer length = context.getArguments()
		        .get(PARAMETER_LENGTH_NAME)
		        .getAsJsonPrimitive()
		        .getAsInt();
