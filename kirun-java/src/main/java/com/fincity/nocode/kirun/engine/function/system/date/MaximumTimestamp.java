...
public class MaximumTimestamp extends AbstractReactiveFunction {
    ...
    public FunctionSignature getSignature() {
        ...
        return new FunctionSignature().setName("MaximumTimestamp")
    ...
    protected Mono<FunctionOutput> internalExecute(ReactiveFunctionExecutionParameters context) {
        ...
        int maxIndex = 0;
        long max = getEpochTime(dates.get(0).getAsString());
        ...
        return Mono.just(new FunctionOutput(List.of(EventResult.outputOf( Map.of( OUTPUT , new JsonPrimitive(dates.get(maxIndex).getAsString()) ) ) )));
    }
