...
class SchemaAnyofValidatorTest {
    ...
    void filterAndComplexConditionTest() {
        ...
        Schema conditions = Schema.ofObject("conditions").setNamespace("test")
                .setProperties(Map.of("completeConditions", Schema.ofArray("completeConditions",
                        Schema.of("singleSchema").setAnyOf(
                                List.of(Schema.of("a").setRef("test.ComplexCondition"),
                                        Schema.of("b").setRef("test.FilterCondition"))))));
