...
public class GetSecondsTest {
	...
	void test() {
		...
		fep.setArguments(Map.of("isoDate", new JsonPrimitive("2024-09-13T23:52:57.633-05:30")));
	...
	void test1() {
		...
		fep.setArguments(Map.of("isoDate", new JsonPrimitive("2019-09-10T00:52:34.633Z")));
