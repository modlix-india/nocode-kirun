...
class IsBeforeTest {
    ...
    void yearTest() {
        ...
        rfep.setArguments(Map.of("isoDate1", new JsonPrimitive("2023-10-31T17:14:21.788Z"), "isoDate2",
    ...
    void hourtest() {
        ...
        rfep.setArguments(Map.of("isoDate1", new JsonPrimitive("2023-10-05T16:14:20.888Z"), "isoDate2",
                new JsonPrimitive("2023-10-05T13:17:22.800Z"), "unit", arr));
