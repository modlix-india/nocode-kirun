...
class MinimumTimeStampTest {
    ...
    void test1() {
        ...
        StepVerifier.create(gmt.execute(rfep))
                .expectNextMatches(r -> {
                    return r.next().getResult().get("minimum").getAsString() == "2023-10-25T12:30:04.970Z";
                }).verifyComplete();
    }
    ...
    void test4() {
        ...
        StepVerifier.create(gmt.execute(rfep))
                .expectNextMatches(r -> {
                    return r.next().getResult().get("minimum").getAsString() == "2023-10-25T13:30:04.970+09:00";
                }).verifyComplete();
    }
    ...
    void test5() {
        ...
        StepVerifier.create(gmt.execute(rfep))
                .expectNextMatches(r -> {
                    return r.next().getResult().get("minimum").getAsString() == "2023-10-25T01:30:04.970Z";
                }).verifyComplete();
    }
