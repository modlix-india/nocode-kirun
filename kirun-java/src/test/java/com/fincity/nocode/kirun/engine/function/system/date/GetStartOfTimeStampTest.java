...
class GetStartOfTimeStampTest {
    ...
    void yeartest() {
        ...
        rfep.setArguments(
                Map.of("isoDate", new JsonPrimitive("1999-09-30T00:00:00.001Z"), "unit", new JsonPrimitive("years")));
        ...
        rfep.setArguments(
                Map.of("isoDate", new JsonPrimitive("1999-09-30T00:00:00.000+09:00"), "unit",
